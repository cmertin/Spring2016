...
MPI_Status stats[REPS*2];
 offset = 0; // Set this badboy equal to zero since each node gets a copy
             // of the array so it isn't requried to be different for every node
