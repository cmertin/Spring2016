...
plt.savefig(plotfile_vorticity_streamfunction, format="pdf")
...
plt.ylabel("$y$")
plt.title(title)
plt.savefig(plotfile_velocityx, format="pdf")
...
plt.ylabel("$y$")
plt.title(title)
plt.savefig(plotfile_velocityy, format="pdf")
...
plt.ylabel("$y$")
plt.title(title)
plt.savefig(plotfile_pressure, format="pdf")
